        ...
        (U.register = t =
            function (e, t) {
                if (Array.isArray(e))
                    ...
                    for (
                        var r = e.split("."), o = tt, i = 0, l = r.length;
                        i < l;
                        i++
                    ) {
                        var s,
                                ...
                                function (n) {
                                    ...
                                    if ("function" == typeof n)
                                        return (
                                            (a = dt(i, l)),
                                            s.map(function (e, t) {
                                                return n(t, ut(i, t, 0, 0, a))
                                                    ? t
                                                    : null;
                                            })
                                        );
                                    var r =
                                        "string" == typeof n ? n.match(vt) : "";
                                    if (r)
                                        switch (r[2]) {
                                            case "visIdx":
                                            case "visible":
