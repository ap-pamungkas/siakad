<x-app>
    <div class="card shadow mt-5">
        ...
        <div class="card-body">
            <form action="{{ url('admin/semester/update') }}/{{ $smtr->id }}" enctype="multipart/form-data" method="POST">
                @csrf
    @method('PUT')
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control select2" style="width: 100%;" name="periode">
                            <option value="{{ $smtr->periode }}" >{{ $smtr->periode }}</option>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" value="{{ $smtr->tahun_ajaran }}" name="tahun_ajaran" class="form-control">
                        @error('images')
